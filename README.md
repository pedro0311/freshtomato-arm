...
8. Login as [username], install base packages with all dependencies:
    ...
    $ sudo apt-get install re2c texlive libelf1 nodejs zip mc cmake curl libglib2.0-dev-bin libglib2.0-dev
