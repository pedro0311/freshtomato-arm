...
#	fixDynDep("radvd", "libdaemon.so.0.5.0");
	...
	fixDynDep("dnscrypt-proxy", "libsodium.so.23.1.0");
...
genSO("${root}/usr/lib/libsodium.so.23.1.0", "${router}/libsodium/src/libsodium/.libs/libsodium.a");
...
genSO("${root}/usr/lib/libipset.so.3.7.0", "${router}/ipset/lib/.libs/libipset.a");
