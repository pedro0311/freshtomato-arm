...
//				    ----- ----- ----- -----  ---  ----  -----  ---- ----   --
	...
	static int r6250[]	= {  11, 255,    15,    3,  255,    1,  255,     8,   8,  255};
	static int r6300v2[]	= {  11, 255,    10,    3,  255,    1,  255,     8,   8,  255};
	static int r6400[]	= {   9, 255,     7,    6,  255,  -11,  255,    12,  13,    8};
	static int r7000[]	= {  13, 255,     9,    3,  255,  -15,  255,   -17, -18,   12};
