...
//				    ----- ----- ----- -----  ---  ----  ------ ---- ----    --
	...
	static int ac68u[]	= { 100,  255,     3,  255,  255,    4,  100,    0,   14,  100};
	static int ac56u[]	= { 100,  255,   255,  255,  255,   -3,  100,    0,   14,  100};
	static int n18u[]	= { 255,  255,     6,  255,  255,  255,    9,    3,   14,  255};
	static int r6250[]	= {  11,  255,    15,  255,  255,    1,  255,    8,  255,  255};
	static int r6300v2[]	= {  11,  255,    10,  255,  255,    1,  255,    8,  255,  255};
	static int r6400[]	= {   9,   -2,     6,  255,  255,   11,  255,   12,   13,    8};
	static int r7000[]	= {  13,  255,     8,  255,  255,   15,  255,   17,   18,   12};
...
/* Assume the LED is the same as ea6700, needs to be verified */
	...
	static int ws880[]	= {   0,  255,   -12,  255,  255,    6,    1,   14,  255,    6};
