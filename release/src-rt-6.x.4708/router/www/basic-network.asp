...
/* DNSCRYPT-BEGIN */
	...
	{ title: '<a href=\'https://github.com/dyne/dnscrypt-proxy/blob/master/dnscrypt-resolvers.csv\' title=\'Resolver details\' class=\'new_window\'>Resolver<\/a>', indent: 2, name: 'dnscrypt_resolver', type: 'select', options: _dnscrypt_resolvers_, value: nvram.dnscrypt_resolver },
