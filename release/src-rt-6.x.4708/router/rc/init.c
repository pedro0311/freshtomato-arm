...
//			nvram_set("pci/1/1/ccode", "Q2");
			...
			nvram_set("pci/1/1/pa2gw0a0", "0xFE9D");
			nvram_set("pci/1/1/pa2gw0a1", "0xFE93");
			nvram_set("pci/1/1/pa2gw0a2", "0xFE77");
			nvram_set("pci/1/1/pa2gw2a0", "0xF9FA");
			nvram_set("pci/1/1/pa2gw2a1", "0xFA15");
			nvram_set("pci/1/1/pa2gw2a2", "0xF9DD");
			nvram_set("pci/1/1/pa2gw1a0", "0x191B");
			nvram_set("pci/1/1/pa2gw1a1", "0x18BC");
			nvram_set("pci/1/1/pa2gw1a2", "0x18B9");
...
//			nvram_set("pci/1/1/regrev", "12");
			...
			nvram_set("pci/1/1/ledbh3", "1");/* DD-WRT 11 */
...
//			nvram_set("pci/2/1/ccode", "Q2");
			...
			nvram_set("pci/2/1/pa5ga0", "0xFF28,0x19CC,0xFCB0,0xFF50,0x1AD0,0xFCE0,0xFF50,0x1B6F,0xFCD0,0xFF58,0x1BB9,0xFCD0");
