...
//			nvram_set("pci/1/1/ccode", "Q2");
			...
			nvram_set("pci/1/1/pa2gw1a0", "0x1b6a");
			nvram_set("pci/1/1/pa2gw1a1", "0x1aea");
			nvram_set("pci/1/1/pa2gw1a2", "0x1ba9");
			nvram_set("pci/1/1/pa2gw2a0", "0xf935");
			nvram_set("pci/1/1/pa2gw2a1", "0xf950");
			nvram_set("pci/1/1/pa2gw2a2", "0xf912");
			nvram_set("pci/1/1/pdetrange2g", "13");
			nvram_set("pci/1/1/phycal_tempdelta", "40");
			nvram_set("pci/1/1/regrev", "916");
			nvram_set("pci/1/1/rpcal2g", "0x0");
			nvram_set("pci/1/1/rxchain", "7");
			nvram_set("pci/1/1/rxgainerr2ga0", "0x4e12");
			nvram_set("pci/1/1/rxgainerr2ga1", "0x4e12");
			nvram_set("pci/1/1/rxgainerr2ga2", "0x4e12");
			nvram_set("pci/1/1/sromrev", "9");
...
//			nvram_set("pci/2/1/ccode", "Q2");
			...
			nvram_set("pci/2/1/mcsbw205glpo", "0x87658600");
			nvram_set("pci/2/1/mcsbw205gmpo", "0xECA86400");
			nvram_set("pci/2/1/mcsbw405ghpo", "0x76558600");
			nvram_set("pci/2/1/mcsbw405glpo", "0x87658600");
			nvram_set("pci/2/1/mcsbw405gmpo", "0xECA86400");
			nvram_set("pci/2/1/mcsbw805ghpo", "0x87659555");
			nvram_set("pci/2/1/mcsbw805glpo", "0x55558888");
			nvram_set("pci/2/1/mcsbw805gmpo", "0xFEA86400");
			nvram_set("pci/2/1/mcsbw1605ghpo", "0");
			nvram_set("pci/2/1/mcsbw1605glpo", "0");
			nvram_set("pci/2/1/mcsbw1605gmpo", "0");
			...
			nvram_set("pci/2/1/measpower1", "0x7f");
			nvram_set("pci/2/1/measpower2", "0x7f");
			nvram_set("pci/2/1/pa5ga0", "0xff46,0x1cde,0xfc98,0xff48,0x1be9,0xfcb1,0xff4a,0x1bbe,0xfcb8,0xff44,0x1a91,0xfcd1");
			nvram_set("pci/2/1/pa5ga1", "0xff44,0x1cc5,0xfc9c,0xff44,0x1b91,0xfcba,0xff42,0x1ae2,0xfcc7,0xff42,0x1af2,0xfcc2");
			nvram_set("pci/2/1/pa5ga2", "0xff48,0x1b4a,0xfcc6,0xff48,0x1b25,0xfcc8,0xff44,0x1aea,0xfcc7,0xff46,0x1a5b,0xfcd8");
			nvram_set("pci/2/1/papdcap5g", "0");
			nvram_set("pci/2/1/pcieingress_war", "15");
			nvram_set("pci/2/1/pdgain5g", "4");
			nvram_set("pci/2/1/pdoffset40ma0", "4369");
			...
			nvram_set("pci/2/1/pwr_scale_1db", "1");
			nvram_set("pci/2/1/regrev", "916");
			nvram_set("pci/2/1/rpcal5gb0", "0x3514");
			nvram_set("pci/2/1/rpcal5gb1", "0x3f10");
			nvram_set("pci/2/1/rpcal5gb2", "0x450b");
			nvram_set("pci/2/1/rpcal5gb3", "0x4e12");
			nvram_set("pci/2/1/rxchain", "7");
			nvram_set("pci/2/1/rxgainerr5ga0", "-2,0,0,-4");
			nvram_set("pci/2/1/rxgainerr5ga1", "-2,0,0,-3");
			nvram_set("pci/2/1/rxgainerr5ga2", "-2,0,0,2");
			nvram_set("pci/2/1/rxgains5gelnagaina0", "3");
...
//			nvram_set("1:regrev", "0");
			...
			if (nvram_match("boardnum", "20140309")) {
				...
				nvram_set("1:antswitch", "0");
				nvram_set("1:boardflags", "0x00000200");
				nvram_set("1:boardflags2", "0x00009800");
				nvram_set("1:bw402gpo", "0x0");
				nvram_set("1:bw40po", "0x0000");
//				nvram_set("1:ccode", "Q2");
				nvram_set("1:cck2gpo", "0x0000");
				nvram_set("1:cddpo", "0x0000");
				nvram_set("1:cdd2gpo", "0x0");
				nvram_set("1:devid", "0x43a9");
				nvram_set("1:extpagain2g", "2");
				nvram_set("1:ledbh0", "11");
				nvram_set("1:ledbh1", "11");
				nvram_set("1:ledbh2", "11");
				nvram_set("1:ledbh3", "11");
				nvram_set("1:leddc", "0xffff");
				nvram_set("1:maxp2ga0", "0x4e");
				nvram_set("1:maxp2ga1", "0x4e");
				nvram_set("1:mcs2gpo0", "0x6666");
				nvram_set("1:mcs2gpo1", "0x6666");
				nvram_set("1:mcs2gpo2", "0x6666");
				nvram_set("1:mcs2gpo3", "0x6666");
				nvram_set("1:mcs2gpo4", "0x6666");
				nvram_set("1:mcs2gpo5", "0x6666");
				nvram_set("1:mcs2gpo6", "0x6666");
				nvram_set("1:mcs2gpo7", "0x6666");
				nvram_set("1:ofdm2gpo", "0x33110000");
				nvram_set("1:pa2gw0a0", "0xFE6B");
				nvram_set("1:pa2gw0a1", "0xFE64");
				nvram_set("1:pa2gw1a0", "0x166B");
				nvram_set("1:pa2gw1a1", "0x1656");
				nvram_set("1:pa2gw2a0", "0xFA7A");
				nvram_set("1:pa2gw2a1", "0xFA76");
				nvram_set("1:pdetrange2g", "2");
				nvram_set("1:phycal_tempdelta", "0");
				nvram_set("1:regrev", "27");
				nvram_set("1:rxchain", "3");
				nvram_set("1:stbc2gpo", "0x0");
				nvram_set("1:stbcpo", "0x0000");
				...
				nvram_set("0:aga1", "4");
				nvram_set("0:antswitch", "0");
				nvram_set("0:boardflags", "0x10000000");
				nvram_set("0:boardflags2", "0x00000002");
				nvram_set("0:boardflags3", "0x00000000");
//				nvram_set("0:ccode", "Q2");
				nvram_set("0:devid", "0x43B3");
				nvram_set("0:dot11agduphrpo", "0x0000");
				nvram_set("0:dot11agduplrpo", "0x0000");
				...
				nvram_set("0:ledbh3", "11");
				nvram_set("0:leddc", "0xffff");
				nvram_set("0:maxp5ga0", "0x4C,0x4C,0x4C,0x4C");
				nvram_set("0:maxp5ga1", "0x4C,0x4C,0x4C,0x4C");
				nvram_set("0:maxp5ga2", "0x4C,0x4C,0x4C,0x4C");
				nvram_set("0:mcsbw205ghpo", "0xdb840000");
				nvram_set("0:mcsbw205glpo", "0xdb840000");
				nvram_set("0:mcsbw205gmpo", "0xdb840000");
				nvram_set("0:mcsbw405ghpo", "0xdb840000");
				nvram_set("0:mcsbw405glpo", "0xdb840000");
				nvram_set("0:mcsbw405gmpo", "0xdb840000");
				nvram_set("0:mcsbw805ghpo", "0xdb432222");
				nvram_set("0:mcsbw805glpo", "0xdb432222");
				nvram_set("0:mcsbw805gmpo", "0xdb432222");
				nvram_set("0:mcsbw1605ghpo", "0x00000000");
				nvram_set("0:mcsbw1605glpo", "0x00000000");
				nvram_set("0:mcsbw1605gmpo", "0x00000000");
				nvram_set("0:mcslr5ghpo", "0x0000");
				nvram_set("0:mcslr5glpo", "0x0000");
				nvram_set("0:mcslr5gmpo", "0x0000");
				nvram_set("0:pa5ga0", "0xff69,0x1637,0xfd4f,0xff63,0x160f,0xfd55,0xff78,0x1722,0xfd43,0xff6b,0x16c3,0xfd43");
				nvram_set("0:pa5ga1", "0xff6a,0x169c,0xfd47,0xff5b,0x1685,0xfd3b,0xff67,0x1702,0xfd3e,0xff77,0x17fd,0xfd25");
				nvram_set("0:pa5ga2", "0xFF4D,0x166C,0xFD2A,0xFF52,0x168A,0xFD31,0xFF5E,0x1768,0xFD25,0xFF61,0x1744,0xFD32");
				nvram_set("0:papdcap5g", "0");
				nvram_set("0:pdgain5g", "10");
				...
				nvram_set("0:phycal_tempdelta", "0");
				nvram_set("0:regrev", "27");
				nvram_set("0:rxchain", "3");
				nvram_set("0:rxgains5gelnagaina0", "3");
				nvram_set("0:rxgains5gelnagaina1", "3");
				nvram_set("0:rxgains5ghelnagaina0", "3");
				...
				nvram_set("0:rxgains5gmelnagaina0", "3");
				nvram_set("0:rxgains5gmelnagaina1", "3");
				...
				nvram_set("0:sb20in40hrpo", "0x0000");
				nvram_set("0:sb20in40lrpo", "0x0000");
				nvram_set("0:sb20in80and160hr5ghpo", "0x0000");
				nvram_set("0:sb20in80and160hr5glpo", "0x0000");
				nvram_set("0:sb20in80and160hr5gmpo", "0x0000");
				nvram_set("0:sb20in80and160lr5ghpo", "0x0000");
				nvram_set("0:sb20in80and160lr5glpo", "0x0000");
				nvram_set("0:sb20in80and160lr5gmpo", "0x0000");
				nvram_set("0:sb40and80hr5ghpo", "0x0000");
				nvram_set("0:sb40and80hr5glpo", "0x0000");
				nvram_set("0:sb40and80hr5gmpo", "0x0000");
				nvram_set("0:sb40and80lr5ghpo", "0x0000");
				nvram_set("0:sb40and80lr5glpo", "0x0000");
				nvram_set("0:sb40and80lr5gmpo", "0x0000");
				nvram_set("0:sromrev", "11");
				nvram_set("0:subband5gver", "4");
				nvram_set("0:temps_hysteresis", "5");
				nvram_set("0:temps_period", "15");
				nvram_set("0:tempthresh", "120");
				nvram_set("0:tempoffset", "0");
