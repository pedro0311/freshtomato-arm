...
void
gt_ggc_mx (struct addr_table_entry_struct& x_r ATTRIBUTE_UNUSED)
{
  struct addr_table_entry_struct * ATTRIBUTE_UNUSED x = &x_r;
  switch ((int) (((*x)).kind))
    {
    case 0:
      gt_ggc_m_7rtx_def ((*x).addr.rtl);
...
void
gt_ggc_mx (struct addr_table_entry_struct *& x)
{
  if (x)
    gt_ggc_mx_addr_table_entry_struct ((void *) x);
}
...
void
gt_pch_nx (struct addr_table_entry_struct& x_r ATTRIBUTE_UNUSED)
{
  struct addr_table_entry_struct * ATTRIBUTE_UNUSED x = &x_r;
  switch ((int) (((*x)).kind))
    {
...
void
gt_pch_nx (struct addr_table_entry_struct *& x)
{
  if (x)
    gt_pch_nx_addr_table_entry_struct ((void *) x);
}
...
void
gt_pch_nx (struct addr_table_entry_struct* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  switch ((int) (((*x)).kind))
