...
satisfies_constraint_j (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (
#line 69 "../../gcc/config/arm/constraints.md"
...
#line 232 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Db (rtx op)
{
  ...
  return 
#line 246 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Dc (rtx op)
{
  ...
  return 
#line 254 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Df (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 273 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Dg (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 279 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Dn (rtx op)
{
  ...
  return 
#line 293 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT
...
{
  return (GET_CODE (op) == CONST_VECTOR) && (
#line 309 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT
...
satisfies_constraint_Do (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 316 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 323 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 330 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 370 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 383 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 418 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB
