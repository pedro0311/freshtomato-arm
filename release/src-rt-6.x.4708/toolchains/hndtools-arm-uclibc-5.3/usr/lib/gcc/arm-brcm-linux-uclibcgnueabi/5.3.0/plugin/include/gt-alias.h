...
gt_ggc_mx_alias_set_entry_d (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_34hash_map_int_int_alias_set_traits_ ((*x).children);
    }
}

void
gt_ggc_mx_hash_map_int_int_alias_set_traits_ (void *x_p)
{
  hash_map<int,int,alias_set_traits> * const x = (hash_map<int,int,alias_set_traits> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct alias_set_traits& x_r ATTRIBUTE_UNUSED)
{
  struct alias_set_traits * ATTRIBUTE_UNUSED x = &x_r;
}
...
gt_pch_nx_alias_set_entry_d (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_17alias_set_entry_d))
    {
      gt_pch_n_34hash_map_int_int_alias_set_traits_ ((*x).children);
    }
}

void
gt_pch_nx_hash_map_int_int_alias_set_traits_ (void *x_p)
{
  hash_map<int,int,alias_set_traits> * const x = (hash_map<int,int,alias_set_traits> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_34hash_map_int_int_alias_set_traits_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct alias_set_traits& x_r ATTRIBUTE_UNUSED)
{
  struct alias_set_traits * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_pch_p_34hash_map_int_int_alias_set_traits_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_map<int,int,alias_set_traits> * x ATTRIBUTE_UNUSED = (struct hash_map<int,int,alias_set_traits> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct alias_set_traits* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
